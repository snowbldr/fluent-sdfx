...
func bowlingPin() {
	b := shape.NewBezier()
	b.Add(0, 0)
	b.Add(2.031/2.0, 0).HandleFwd(45, 2)
	b.Add(4.766/2.0, 4.5).Handle(90, 2, 2)
	b.Add(1.797/2.0, 10).Handle(90, 3, 3)
	b.Add(2.547/2.0, 13.5).Handle(90, 1, 1)
	b.Add(0, 15).HandleRev(0, 1)
	b.Close()

	b.Build().Revolve().STL("bowlingpin.stl", 3.0)
}

func egg1() {
	b := shape.NewBezier()
	b.Add(0, 0).HandleFwd(0, 10)
	b.Add(0, 16).HandleRev(0, 5)
	b.Close()

	b.Build().Revolve().STL("egg1.stl", 3.0)
}
...
func egg2() {
	...
	b := shape.NewBezier()
	b.Add(0, 0).HandleFwd(0, r/2)
	b.Add(r, 0.4*h).Handle(90, 0.7*r, 0.7*r)
	b.Add(0, h).HandleRev(0, r/3)
	b.Close()

	b.Build().Revolve().STL("egg2.stl", 3.0)
}
...
func bowl() {
	...
	b.Build().RevolveAngle(270).STL("bowl.stl", 3.0)
}
...
func vase() {
	...
	b.Build().Revolve().STL("vase.stl", 3.0)
}
...
func shapeFn() {
	...
	s0.Cut(s1.Union(s2, s3, s4, s5)).ExtrudeRounded(200, 20).STL("shape.stl", 3.0)
}
