...
func main() {
	...
	driver := sDriver.Extrude(wheelHeight).BottomAt(0)
	base := solid.Cylinder(wheelHeight, baseRadius, 0).TopAt(0)
	...
	driven := sDriven.Extrude(wheelHeight).TopAt(0)
	hub := solid.Cylinder(wheelHeight, hubRadius, 0).BottomAt(0)
