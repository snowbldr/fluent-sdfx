// Package asfailed is what the model actually built in the source incident:
// it read "too long" as the Z height and reduced the boss HEIGHT, leaving
// the tangential length untouched (mcweed U209-U215, two wasted prints).
